...
@Component({
  ...
  template: `
    <div class="p-3 p-md-4">
      <!-- Welcome Banner -->
      <div
        class="rounded-4 p-4 mb-4 text-white position-relative overflow-hidden"
      ...
      >
        <div class="position-relative" style="z-index:1">
          ...
          @if (storeName()) {
            <p class="mb-0 opacity-75 small"><i class="bi bi-shop me-1"></i>{{ storeName() }}</p>
          }
        </div>
        <!-- Decorative circles -->
        <div
          style="position:absolute;top:-40px;right:-40px;width:200px;height:200px;
          border-radius:50%;background:rgba(255,255,255,0.03)"
        ></div>
        <div
          style="position:absolute;bottom:-60px;right:60px;width:150px;height:150px;
          border-radius:50%;background:rgba(74,222,128,0.07)"
        ></div>
      </div>
          ...
          <div class="card border-0 shadow-sm rounded-4 h-100">
            <div class="card-body p-3">
              <div class="d-flex align-items-start justify-content-between">
                <div>
                  <p
                    class="text-muted small fw-semibold mb-1 text-uppercase"
      ...
      @if (!isLoading() && lowStockProducts().length > 0) {
        <div
          class="rounded-4 p-3 mb-4 d-flex align-items-start gap-3"
          style="background:#fffbeb;border:1px solid #fde68a"
        >
          <i
            class="bi bi-exclamation-triangle-fill mt-1 shrink-0"
            style="color:#d97706;font-size:1.1rem"
          ></i>
          <div class="grow">
          ...
          <a
            routerLink="/seller/products"
            class="btn btn-sm rounded-pill shrink-0"
      ...
      <div class="row g-4">
        ...
        <div class="col-12 col-xl-7">
          <div class="card border-0 shadow-sm rounded-4 h-100">
            <div
              class="card-header bg-transparent border-0 pt-4 px-4 pb-0
                    ...
                    <tbody>
                      @for (o of recentOrders(); track o._id) {
                        <tr style="border-bottom:1px solid #f1f5f9">
                          ...
                          <td class="py-3 fw-semibold text-success">\${{ o.total_price }}</td>
                          <td class="pe-4 py-3">
  ...
  ngOnInit(): void {
    ...
    this.sellerService.getMyOrders().subscribe({
      next: (res) => {
        ...
        const all: SellerOrder[] = Array.isArray(res.data) ? res.data : [];
