    ...
    <div class="container py-5">
      @if (isLoading()) {
        ...
        <div class="row g-4">
            ...
            <div class="card shadow-sm border-0 h-100">
              ...
              <div class="card-body">
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    <label class="form-label small fw-semibold">{{
                      'profile.preferredLanguage' | translate
                    }}</label>
                    <select
                      class="form-select"
                      [ngModel]="user.preferred_language"
                      (ngModelChange)="updateField('preferred_language', $event)"
                    >
          ...
          <div class="col-lg-4">
            <div
              class="card bg-dark text-white shadow border-0 mb-4 overflow-hidden position-relative"
            >
              <div class="card-body p-4">
                <p class="text-white-50 small mb-1">{{ 'profile.availableBalance' | translate }}</p>
                <h2 class="display-6 fw-bold mb-0">{{ user.wallet_balance | currency: 'USD' }}</h2>
                <i
                  class="bi bi-wallet2 position-absolute top-50 end-0 translate-middle-y opacity-25 me-3"
            ...
            <div
              class="card bg-warning-subtle text-warning-emphasis shadow-sm border-0 overflow-hidden"
            >
              <div class="card-body p-4 text-center">
                <p class="small mb-1 text-uppercase fw-bold opacity-75">
                  {{ 'profile.loyaltyPoints' | translate }}
                </p>
              ...
              <div class="bg-warning py-1 text-center small fw-bold text-dark">
                {{ 'profile.rewardsMember' | translate }}
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="text-center py-5 text-muted">
          ...
          <p>{{ 'profile.noProfile' | translate }}</p>
        </div>
      }
    </div>
  `,
