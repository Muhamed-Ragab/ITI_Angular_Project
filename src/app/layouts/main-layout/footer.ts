  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <p class="small">
          Goshop is an online store that offers the best products at the best prices in Egypt. Shop easily and enjoy a smooth and unique shopping experience.
        </p>
      ...
      <div class="col-md-2 mb-4">
        ...
        <ul class="list-unstyled">
          ...
          <li><a routerLink="/products" class="text-decoration-none text-light">Products</a></li>
          <li><a routerLink="/categories" class="text-decoration-none text-light">Categories</a></li>
      ...
      <div class="col-md-3 mb-4">
        ...
        <ul class="list-unstyled">
          <li><a href="#" class="text-decoration-none text-light">My Account</a></li>
          <li><a href="#" class="text-decoration-none text-light">Orders</a></li>
          <li><a href="#" class="text-decoration-none text-light">Wishlist</a></li>
          <li><a href="#" class="text-decoration-none text-light">Help</a></li>
        </ul>
      </div>
